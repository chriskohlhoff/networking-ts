...
\pnum
Unless otherwise specified, references to other entities described in this Technical Specification are assumed to be qualified with \tcode{std::experimental::net::v1::}, references to entities described in the \Cpp standard are assumed to be qualified with \tcode{std::}, references to entities described in \Cpp Extensions for Library Fundamentals are assumed to be qualified with \tcode{std::experimental::fundamentals_v2::}, and references to entities described in P0443R7 A Unified Executors Proposal for \Cpp are assumed to be qualified with \tcode{std::experimental::executors_v1::}.
