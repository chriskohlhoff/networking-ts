...
The member function \tcode{dispatch} may be recursively reentered.
...
\tcode{x1} and \tcode{x2} denote (possibly const) values of type \tcode{X},
...
\tcode{a} denotes a (possibly const) value of type \tcode{A}
